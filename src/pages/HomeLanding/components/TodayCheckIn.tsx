...
export function TodayCheckIn() {
    ...
    const getDeviceDetail = () => {
        return {
            device: `${deviceType} ${osName} ${mobileModel} ${mobileVendor}/ engine:${engineName}${engineVersion}/ browser:${browserName}${fullBrowserVersion}`,
            getUA: getUA,
        };
        // return {
    ...
    const onCheckin: OnCheckinType = async (isWorkOutside = false, remark, latlng, reason) => {
        ...
        if (profile) {
            ...
            const payload: CheckinDate = {
                ...
                approveBySuid: res?.approveBySuid || '',
